    ...
    partial class VerFaltasGPM
    {
        ...
        protected override void OnParametersSet()
        {
            try
            {
                ...
                faltasDeServidoresPublicosMorales.SancionEconomica.SancionEfectivamenteCobrada ??= new();
                faltasDeServidoresPublicosMorales.Indeminizacion.IndeminizacionECobrada ??= new();
